...
var require_browser_crypto = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_event$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_url = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:utils:url");
	module.exports = {
...
var require_emitter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), EventTarget = require_eventtarget();
...
var require_websocket = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var utils = require_event$1(), urlUtils = require_url(), inherits = require_inherits_browser(), EventEmitter = require_emitter().EventEmitter, WebsocketDriver = require_websocket$1();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:websocket");
...
var require_buffered_sender = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), EventEmitter = require_emitter().EventEmitter;
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:buffered-sender");
...
var require_polling = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), EventEmitter = require_emitter().EventEmitter;
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:polling");
	...
	Polling.prototype._scheduleReceiver = function() {
		...
		poll.once("close", function(code, reason) {
			...
			self.poll = poll = null;
			if (!self.pollIsClosing) if (reason === "network") self._scheduleReceiver();
			else {
...
var require_sender_receiver = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), urlUtils = require_url(), BufferedSender = require_buffered_sender(), Polling = require_polling();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:sender-receiver");
...
var require_ajax_based = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), urlUtils = require_url(), SenderReceiver = require_sender_receiver();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:ajax-based");
	function createAjaxSender(AjaxObject) {
		return function(url, payload, callback) {
			debug("create ajax sender", url, payload);
			var opt = {};
			if (typeof payload === "string") opt.headers = { "Content-type": "text/plain" };
			var xo = new AjaxObject("POST", urlUtils.addPath(url, "/xhr_send"), payload, opt);
...
var require_xhr = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), EventEmitter = require_emitter().EventEmitter;
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:receiver:xhr");
...
var require_abstract_xhr = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_emitter().EventEmitter, inherits = require_inherits_browser(), utils = require_event$1(), urlUtils = require_url(), XHR = global.XMLHttpRequest;
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:browser:xhr");
...
var require_xhr_cors = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), XhrDriver = require_abstract_xhr();
...
var require_xhr_local = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), XhrDriver = require_abstract_xhr();
...
var require_xhr_streaming = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), AjaxBasedTransport = require_ajax_based(), XhrReceiver = require_xhr(), XHRCorsObject = require_xhr_cors(), XHRLocalObject = require_xhr_local(), browser = require_browser();
...
var require_xdr = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_emitter().EventEmitter, inherits = require_inherits_browser(), eventUtils = require_event$1(), browser = require_browser(), urlUtils = require_url();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:sender:xdr");
...
var require_xdr_streaming = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), AjaxBasedTransport = require_ajax_based(), XhrReceiver = require_xhr(), XDRObject = require_xdr();
...
var require_eventsource$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = global.EventSource;
}));
//#endregion
//#region node_modules/sockjs-client/lib/transport/receiver/eventsource.js
var require_eventsource$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), EventEmitter = require_emitter().EventEmitter, EventSourceDriver = require_eventsource$2();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:receiver:eventsource");
...
var require_eventsource = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), AjaxBasedTransport = require_ajax_based(), EventSourceReceiver = require_eventsource$1(), XHRCorsObject = require_xhr_cors(), EventSourceDriver = require_eventsource$2();
...
//#endregion
//#region node_modules/json3/lib/json3.js
var require_json3 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	(function() {
		...
		function runInContext(context, exports$1) {
			context || (context = root.Object());
			exports$1 || (exports$1 = root.Object());
			...
			if (typeof nativeJSON == "object" && nativeJSON) {
				exports$1.stringify = nativeJSON.stringify;
				exports$1.parse = nativeJSON.parse;
			}
			...
			function has(name) {
				if (has[name] != null) return has[name];
				var isSupported;
				if (name == "bug-string-char-index") isSupported = "a"[0] != "a";
				else if (name == "json") isSupported = has("json-stringify") && has("date-serialization") && has("json-parse");
				else if (name == "date-serialization") {
					isSupported = has("json-stringify") && isExtended;
					if (isSupported) {
						var stringify = exports$1.stringify;
						attempt(function() {
					...
					if (name == "json-stringify") {
						var stringify = exports$1.stringify, stringifySupported = typeof stringify == "function";
						if (stringifySupported) {
							(value = function() {
								return 1;
							}).toJSON = value;
							attempt(function() {
								stringifySupported = stringify(0) === "0" && stringify(new Number()) === "0" && stringify(new String()) == "\"\"" && stringify(getClass) === undefined && stringify(undefined) === undefined && stringify() === undefined && stringify(value) === "1" && stringify([value]) == "[1]" && stringify([undefined]) == "[null]" && stringify(null) == "null" && stringify([
									undefined,
									getClass,
									null
								]) == "[null,null,null]" && stringify({ "a": [
									value,
									true,
									false,
									null,
					...
					if (name == "json-parse") {
						var parse = exports$1.parse, parseSupported;
						if (typeof parse == "function") attempt(function() {
							if (parse("0") === 0 && !parse(false)) {
								...
								if (parseSupported) {
									...
									if (parseSupported) attempt(function() {
			...
			if (!has("json")) {
				...
				var forOwn = function(object, callback) {
					...
					for (property in dontEnums) if (isProperty.call(dontEnums, property)) size++;
					...
					if (!size) {
						...
						forOwn = function(object, callback) {
							...
							for (length = dontEnums.length; property = dontEnums[--length];) if (hasProperty.call(object, property)) callback(property);
						};
					} else forOwn = function(object, callback) {
				...
				if (!has("json-stringify") && !has("date-serialization")) {
					...
					if (has("json-stringify") && !has("date-serialization")) {
						...
						var nativeStringify = exports$1.stringify;
						exports$1.stringify = function(source, filter, width) {
						...
						var serialize = function(property, object, callback, properties, whitespace, indentation, stack) {
							...
							if (typeof value == "object" && value) {
								if (value.getUTCFullYear && getClass.call(value) == dateClass && value.toJSON === Date.prototype.toJSON) value = serializeDate(value);
							...
							switch (className || type) {
								case "boolean":
								case booleanClass: return "" + value;
								case "number":
								case numberClass: return value > -Infinity && value < Infinity ? "" + value : "null";
								case "string":
								case stringClass: return quote("" + value);
							}
							if (typeof value == "object") {
								...
								if (className == arrayClass) {
									...
									forOwn(properties || value, function(property) {
										...
										if (element !== undefined) results.push(quote(property) + ":" + (whitespace ? " " : "") + element);
									});
									result = results.length ? whitespace ? "{\n" + indentation + results.join(",\n" + indentation) + "\n" + prefix + "}" : "{" + results.join(",") + "}" : "{}";
								}
								stack.pop();
						...
						exports$1.stringify = function(source, filter, width) {
							...
							if (objectTypes[typeof filter] && filter) {
								...
								if (className == functionClass) callback = filter;
				...
				if (!has("json-parse")) {
					...
					var update = function(source, property, callback) {
						...
						if (element === undefined) delete source[property];
						else source[property] = element;
					};
					var walk = function(source, property, callback) {
						var value = source[property], length;
						if (typeof value == "object" && value) if (getClass.call(value) == arrayClass) for (length = value.length; length--;) update(getClass, forOwn, value, length, callback);
						else forOwn(value, function(property) {
							update(value, property, callback);
						});
						return callback.call(source, property, value);
					};
					exports$1.parse = function(source, callback) {
						var result, value;
						Index = 0;
						Source = "" + source;
						result = get(lex());
			...
			exports$1.runInContext = runInContext;
			return exports$1;
		}
...
var require_iframe$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var eventUtils = require_event$1(), JSON3 = require_json3(), browser = require_browser();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:utils:iframe");
	module.exports = {
		WPrefix: "_jp",
		...
		postMessage: function(type, data) {
			if (global.parent !== global) global.parent.postMessage(JSON3.stringify({
	...
	if (global.document) module.exports.iframeEnabled = (typeof global.postMessage === "function" || typeof global.postMessage === "object") && !browser.isKonqueror();
}));
//#endregion
//#region node_modules/sockjs-client/lib/transport/iframe.js
var require_iframe = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), JSON3 = require_json3(), EventEmitter = require_emitter().EventEmitter, version = require_version(), urlUtils = require_url(), iframeUtils = require_iframe$1(), eventUtils = require_event$1(), random = require_random();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:transport:iframe");
...
var require_iframe_wrap = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), IframeTransport = require_iframe(), objectUtils = require_object();
...
var require_htmlfile$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), iframeUtils = require_iframe$1(), urlUtils = require_url(), EventEmitter = require_emitter().EventEmitter, random = require_random();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:receiver:htmlfile");
...
var require_htmlfile = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), HtmlfileReceiver = require_htmlfile$1(), XHRLocalObject = require_xhr_local(), AjaxBasedTransport = require_ajax_based();
...
var require_xhr_polling = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), AjaxBasedTransport = require_ajax_based(), XhrReceiver = require_xhr(), XHRCorsObject = require_xhr_cors(), XHRLocalObject = require_xhr_local();
...
var require_xdr_polling = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), AjaxBasedTransport = require_ajax_based(), XdrStreamingTransport = require_xdr_streaming(), XhrReceiver = require_xhr(), XDRObject = require_xdr();
...
var require_jsonp$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var utils = require_iframe$1(), random = require_random(), browser = require_browser(), urlUtils = require_url(), inherits = require_inherits_browser(), EventEmitter = require_emitter().EventEmitter;
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:receiver:jsonp");
	function JsonpReceiver(url) {
		...
		this.timeoutId = setTimeout(function() {
			debug("timeout");
			self._abort(/* @__PURE__ */ new Error("JSONP script loaded abnormally (timeout)"));
	...
	JsonpReceiver.prototype._scriptError = function() {
		...
		this.errorTimer = setTimeout(function() {
			if (!self.loadedOkay) self._abort(/* @__PURE__ */ new Error("JSONP script loaded abnormally (onerror)"));
	...
	JsonpReceiver.prototype._createScript = function(url) {
		...
		script.onload = function() {
			debug("onload");
			self._abort(/* @__PURE__ */ new Error("JSONP script loaded abnormally (onload)"));
		};
		script.onreadystatechange = function() {
			...
			if (/loaded|closed/.test(script.readyState)) {
				...
				if (script) self._abort(/* @__PURE__ */ new Error("JSONP script loaded abnormally (onreadystatechange)"));
			}
		};
		if (typeof script.async === "undefined" && global.document.attachEvent) if (!browser.isOpera()) {
			try {
...
var require_jsonp = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var random = require_random(), urlUtils = require_url();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:sender:jsonp");
	var form, area;
...
var require_jsonp_polling = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), SenderReceiver = require_sender_receiver(), JsonpReceiver = require_jsonp$1(), jsonpSender = require_jsonp();
...
var require_transport_list = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = [
		require_websocket(),
...
var require_shims = /* @__PURE__ */ __commonJSMin((() => {
...
var require_transport = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:utils:transport");
...
var require_close = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), Event = require_event();
	function CloseEvent() {
		Event.call(this);
...
var require_trans_message = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), Event = require_event();
...
var require_xhr_fake = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_emitter().EventEmitter, inherits = require_inherits_browser();
	function XHRFake() {
		var self = this;
		EventEmitter.call(this);
...
var require_info_ajax = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_emitter().EventEmitter, inherits = require_inherits_browser(), JSON3 = require_json3(), objectUtils = require_object();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:info-ajax");
...
var require_info_iframe_receiver = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser(), EventEmitter = require_emitter().EventEmitter, JSON3 = require_json3(), XHRLocalObject = require_xhr_local(), InfoAjax = require_info_ajax();
...
var require_info_iframe = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_emitter().EventEmitter, inherits = require_inherits_browser(), JSON3 = require_json3(), utils = require_event$1(), IframeTransport = require_iframe(), InfoReceiverIframe = require_info_iframe_receiver();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:info-iframe");
...
var require_info_receiver = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_emitter().EventEmitter, inherits = require_inherits_browser(), urlUtils = require_url(), XDR = require_xdr(), XHRCors = require_xhr_cors(), XHRLocal = require_xhr_local(), XHRFake = require_xhr_fake(), InfoIframe = require_info_iframe(), InfoAjax = require_info_ajax();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:info-receiver");
...
var require_facade = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var JSON3 = require_json3(), iframeUtils = require_iframe$1();
...
var require_iframe_bootstrap = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var urlUtils = require_url(), eventUtils = require_event$1(), JSON3 = require_json3(), FacadeJS = require_facade(), InfoIframeReceiver = require_info_iframe_receiver(), iframeUtils = require_iframe$1(), loc = require_location();
	var debug = function() {};
	debug = require_browser$1()("sockjs-client:iframe-bootstrap");
